...
const Layout: React.FC<LayoutProps> = ({ children, title, additionalContent, showBackButton = true, showToggle = false, options = [], rightSidebar }) => {
  ...
  return (
    <div className="bg-black min-h-screen text-white flex">
      ...
      {rightSidebar && (
        <aside className="fixed top-0 right-0 w-80 h-screen border-l border-gray-800 bg-black overflow-y-auto">
          {rightSidebar}
        </aside>
      )}
    </div>
